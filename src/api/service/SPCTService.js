...
export const getAllSeri = async () => {
  const response = await axios.get(`${URL_API}/seri`);
  console.log(response);
  return response.data;
};
...
export const addCpu = async (cpuData) => {
  try {
    const response = await axios.post(`${URL_API}/cpu/add`, cpuData);
...
export const addRam = async (ramData) => {
  try {
    const response = await axios.post(`${URL_API}/ram/add`, ramData);
    console.log("Phản hồi từ server:", response.data);
    return response.data;
  } catch (error) {
...
export const updateRam = async (id, ramData) => {
  await axios.put(`${URL_API}/ram/update/${id}`, ramData);
};

export const deleteRam = async (id) => {
  await axios.delete(`${URL_API}/ram/delete/${id}`);
};
/*gpu*/
export const addGpu = async (gpuData) => {
  try {
    const response = await axios.post(`${URL_API}/gpu/add`, gpuData);
    console.log("Phản hồi từ server:", response.data);
    return response.data;
  } catch (error) {
...
export const updateGpu = async (id, gpuData) => {
  await axios.put(`${URL_API}/gpu/update/${id}`, gpuData);
};

export const deleteGpu = async (id) => {
  await axios.delete(`${URL_API}/gpu/delete/${id}`);
};
/*manHinh*/
export const addManHinh = async (manHinhData) => {
  try {
    const response = await axios.post(`${URL_API}/man-hinh/add`, manHinhData);
    console.log("Phản hồi từ server:", response.data);
    return response.data;
  } catch (error) {
...
export const updateManHinh = async (id, manHinhData) => {
  await axios.put(`${URL_API}/man-hinh/update/${id}`, manHinhData);
};

export const deleteManHinh = async (id) => {
  await axios.delete(`${URL_API}/man-hinh/delete/${id}`);
};
/*oCung*/
export const addOCung = async (oCungData) => {
  try {
    const response = await axios.post(`${URL_API}/o-cung/add`, oCungData);
    console.log("Phản hồi từ server:", response.data);
    return response.data;
  } catch (error) {
...
export const updateOCung = async (id, oCungData) => {
  await axios.put(`${URL_API}/o-cung/update/${id}`, oCungData);
};

export const deleteOCung = async (id) => {
  await axios.delete(`${URL_API}/o-cung/delete/${id}`);
};
/*mauSac*/
export const addMauSac = async (mauSacData) => {
  try {
    const response = await axios.post(`${URL_API}/mau-sac/add`, mauSacData);
    console.log("Phản hồi từ server:", response.data);
    return response.data;
  } catch (error) {
...
export const updateMauSac = async (id, mauSacData) => {
  await axios.put(`${URL_API}/mau-sac/update/${id}`, mauSacData);
};

export const deleteMauSac = async (id) => {
  await axios.delete(`${URL_API}/mau-sac/delete/${id}`);
};
/*pin*/
export const addPin = async (pinData) => {
  try {
    const response = await axios.post(`${URL_API}/pin-sac/add`, pinData);
    console.log("Phản hồi từ server:", response.data);
    return response.data;
  } catch (error) {
...
export const updatePin = async (id, pinData) => {
  await axios.put(`${URL_API}/pin-sac/update/${id}`, pinData);
};

export const deletePin = async (id) => {
  await axios.delete(`${URL_API}/pin-sac/delete/${id}`);
};
/*spct*/
export const addSPCT = async (spctData) => {
  try {
    const response = await axios.post(`${URL_API}/add`, spctData);
    console.log("Phản hồi từ server:", response.data);
    return response.data;
  } catch (error) {
...
export const updateSPCT = async (id, spctData) => {
  await axios.put(`${URL_API}/update/${id}`, spctData);
};
