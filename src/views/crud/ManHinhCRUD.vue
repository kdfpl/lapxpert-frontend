...
import { getAllManHinh, addManHinh, updateManHinh } from "../../service/SPCTService.js";
...
const handleSubmit = async () => {
  try {
    ...
    router.push("/manHInh"); // Điều hướng về danh sách
  } catch (error) {
  ...
  <div class="relative w-full mt-5">
    ...
    <div
      ...
      <button
        ...
        <router-link to="/manHInh">Danh Sách</router-link>
      </button>
    </div>
  </div>
  <div class="flex">
