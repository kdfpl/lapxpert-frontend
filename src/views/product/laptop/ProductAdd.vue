...
import { addSanPham } from "@/api/service/sanphamservice";
import { addSPCT } from "@/api/service/spctservice";
...
const submitForm = async () => {
  try {
    ...
    // Bước 2: Gán sản phẩm vào spctData
    spctData.sanPham = sanPhamMoi;

    // Bước 3: Thêm Sản phẩm chi tiết
