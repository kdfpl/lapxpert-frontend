<template>
    <div class="p-6 mx-auto bg-white rounded-xl shadow-lg border border-gray-200">
      <div class="relative h-40 bg-cover"
           style="background-image: url('https://res.cloudinary.com/dieecfslw/image/upload/v1741458467/e8c999770d2a02ffab41f0e1e6c9de15_pnvbye.jpg'); background-position: center -90px; margin-bottom: 20px;">
      </div>
      ...
      <div class="flex justify-end items-center gap-3 mb-4">
        ...
        <!-- Nút Nhập Excel & Thêm khách hàng -->
        <button class="border border-gray-300 px-4 py-2 rounded-lg bg-gray-100 hover:bg-gray-200 duration-200 ease-out hover:bg-opacity-90 hover:scale-105 active:scale-95 active:shadow-md">
          Nhập Excel
        </button>
      ...
      <div class="overflow-x-auto">
        <table class="w-full border-collapse border border-gray-300">
          ...
          <tr>
            ...
            <th class="border border-gray-300 p-2 w-48">Email</th>
          ...
          <tbody>
          <tr v-for="(customer, index) in customerss" :key="index" class="text-center">
            <td class="border border-gray-300 p-2">{{ index + 1 }}</td>
            <td class="border border-gray-300 p-2">{{ customer.code }}</td>
            ...
            <td class="border border-gray-300 p-2 w-50">
                              <span
                                  :class="customer.status === 'Hoạt động' ? 'text-green-600 border border-green-600 px-2 py-1 rounded' : 'text-red-600 border border-red-600 px-2 py-1 rounded'">
                                  {{ customer.status }}
                              </span>
            </td>
  ...
  const customerss = ref([
    { code: "Linhhm", name: "Hoàng Mai Linh", phone: "0123456789", email: "abc@gmail.com", address: "3 P. Trịnh Văn Bô, Xuân Phương, Nam Từ Liêm, Hà Nội", status: "Hoạt động" },
    { code: "Linhhm", name: "Hoàng Mai Linh", phone: "0123456789", email: "abc@gmail.com", address: "3 P. Trịnh Văn Bô, Xuân Phương, Nam Từ Liêm, Hà Nội", status: "Không hoạt động" },
    { code: "Linhhm", name: "Hoàng Mai Linh", phone: "0123456789", email: "abc@gmail.com", address: "3 P. Trịnh Văn Bô, Xuân Phương, Nam Từ Liêm, Hà Nội", status: "Hoạt động" },
    { code: "Linhhm", name: "Hoàng Mai Linh", phone: "0123456789", email: "abc@gmail.com", address: "3 P. Trịnh Văn Bô, Xuân Phương, Nam Từ Liêm, Hà Nội", status: "Không hoạt động" },
  ]);
  </script>